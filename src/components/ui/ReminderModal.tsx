        ...
        <div className="p-6 space-y-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 className="text-base font-bold text-on-surface">Reminder</h3>
          ...
          <div className="space-y-1.5">
            ...
            <select value={reminder.frequency} onChange={e => update("frequency", e.target.value)}
              className="w-full h-11 px-4 bg-slate-50 border border-slate-200 text-on-surface rounded-xl focus:border-primary outline-none text-sm font-semibold appearance-none">
                  ...
                  <button key={d} type="button" onClick={() => toggleDay(d)}
                    className={`w-10 h-10 rounded-full text-[10px] font-bold transition-all cursor-pointer ${
                      active
                        ...
                        : "bg-transparent border border-slate-200 text-on-surface hover:border-primary/50"
                    }`}>
                    {d}
                  </button>
                )
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-[9px] text-on-surface-variant">Start — End date (leave end blank for ongoing)</p>
          </div>
        </div>
